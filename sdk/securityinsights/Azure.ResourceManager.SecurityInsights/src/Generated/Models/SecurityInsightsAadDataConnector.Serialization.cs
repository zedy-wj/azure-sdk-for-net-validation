...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityInsightsAadDataConnector>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SecurityInsightsAadDataConnector)} does not support writing '{format}' format.");
            }
        ...
        SecurityInsightsAadDataConnector IJsonModel<SecurityInsightsAadDataConnector>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SecurityInsightsAadDataConnector)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SecurityInsightsAadDataConnector>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SecurityInsightsAadDataConnector)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SecurityInsightsAadDataConnector IPersistableModel<SecurityInsightsAadDataConnector>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SecurityInsightsAadDataConnector)} does not support reading '{options.Format}' format.");
            }
        }
