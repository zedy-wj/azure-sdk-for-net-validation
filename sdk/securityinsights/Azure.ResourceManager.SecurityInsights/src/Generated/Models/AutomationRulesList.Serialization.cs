...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    internal partial class AutomationRulesList : IUtf8JsonSerializable, IJsonModel<AutomationRulesList>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AutomationRulesList>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AutomationRulesList IJsonModel<AutomationRulesList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AutomationRulesList>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static AutomationRulesList DeserializeAutomationRulesList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AutomationRulesList(value, nextLink, serializedAdditionalRawData);
        }
        ...
        AutomationRulesList IPersistableModel<AutomationRulesList>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AutomationRulesList>)this).GetFormatFromOptions(options) : options.Format;
