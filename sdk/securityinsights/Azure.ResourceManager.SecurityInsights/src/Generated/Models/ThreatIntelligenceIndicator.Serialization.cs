...
{
    public partial class ThreatIntelligenceIndicator : IUtf8JsonSerializable, IJsonModel<ThreatIntelligenceIndicator>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ThreatIntelligenceIndicator>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ThreatIntelligenceIndicator>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ThreatIntelligenceIndicator IJsonModel<ThreatIntelligenceIndicator>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ThreatIntelligenceIndicator>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ThreatIntelligenceIndicator DeserializeThreatIntelligenceIndicator(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            {
                if (property.NameEquals("observables"u8))
                {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(Observables), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  observables: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                if (Optional.IsCollectionDefined(Observables))
                {
                    if (Observables.Any())
                    {
                        ...
                        foreach (var item in Observables)
                        {
                            BicepSerializationHelpers.AppendChildObject(builder, item, options, 4, true, "  observables: ");
                        }
                        builder.AppendLine("  ]");
                    }
                }
        ...
        BinaryData IPersistableModel<ThreatIntelligenceIndicator>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ThreatIntelligenceIndicator>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ThreatIntelligenceIndicator IPersistableModel<ThreatIntelligenceIndicator>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ThreatIntelligenceIndicator>)this).GetFormatFromOptions(options) : options.Format;
