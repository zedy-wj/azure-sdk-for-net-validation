...
namespace Azure.ResourceManager.SecurityInsights.Models
{
    ...
    public partial class ThreatIntelligenceCountQuery
    {
        ...
        internal ThreatIntelligenceCountQuery(ThreatIntelligenceQueryCondition condition, ThreatIntelligenceQuerySortBy sortBy, int? maxPageSize, int? minPageSize, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Condition = condition;
            SortBy = sortBy;
