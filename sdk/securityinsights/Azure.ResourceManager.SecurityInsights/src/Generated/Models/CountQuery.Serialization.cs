...
{
    public partial class CountQuery : IUtf8JsonSerializable, IJsonModel<CountQuery>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CountQuery>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CountQuery>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        CountQuery IJsonModel<CountQuery>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CountQuery>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static CountQuery DeserializeCountQuery(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CountQuery(condition, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<CountQuery>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CountQuery>)this).GetFormatFromOptions(options) : options.Format;
        ...
        CountQuery IPersistableModel<CountQuery>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CountQuery>)this).GetFormatFromOptions(options) : options.Format;
