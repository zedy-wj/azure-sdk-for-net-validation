...
{
    public partial class SecurityInsightsTemplateData : IUtf8JsonSerializable, IJsonModel<SecurityInsightsTemplateData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityInsightsTemplateData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<SecurityInsightsTemplateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SecurityInsightsTemplateData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SecurityInsightsTemplateData)} does not support writing '{format}' format.");
            }
        ...
        SecurityInsightsTemplateData IJsonModel<SecurityInsightsTemplateData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SecurityInsightsTemplateData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SecurityInsightsTemplateData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeSecurityInsightsTemplateData(document.RootElement, options);
        }

        internal static SecurityInsightsTemplateData DeserializeSecurityInsightsTemplateData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            else
            {
                if (Optional.IsCollectionDefined(DependantTemplates))
                {
                    if (DependantTemplates.Any())
                    {
                        ...
                        foreach (var item in DependantTemplates)
                        {
                            BicepSerializationHelpers.AppendChildObject(builder, item, options, 6, true, "    dependantTemplates: ");
                        }
                        builder.AppendLine("    ]");
                    }
                }
        ...
        BinaryData IPersistableModel<SecurityInsightsTemplateData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SecurityInsightsTemplateData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SecurityInsightsTemplateData)} does not support writing '{options.Format}' format.");
            }
        }

        SecurityInsightsTemplateData IPersistableModel<SecurityInsightsTemplateData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SecurityInsightsTemplateData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SecurityInsightsTemplateData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<SecurityInsightsTemplateData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
