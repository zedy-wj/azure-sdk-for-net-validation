...
{
    /// <summary>
    /// A class representing the SecurityInsightsBillingStatistic data model.
    /// Billing statistic
    ...
    public abstract partial class SecurityInsightsBillingStatisticData : ResourceData
    {
        ...
        internal SecurityInsightsBillingStatisticData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BillingStatisticKind kind, ETag? etag, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
            ETag = etag;
