...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public partial class SecurityInsightsAlertRuleResource : ArmResource
    {
        ...
        private readonly AlertRuleRestOperations _alertRuleRestClient;
        ...
        internal SecurityInsightsAlertRuleResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _alertRuleClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.SecurityInsights", ProviderConstants.DefaultProviderNamespace, Diagnostics);
            _alertRuleRestClient = new AlertRuleRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint);
#if DEBUG
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>alertRule_TriggerRuleRun</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-07-01-preview</description>
        ...
        public virtual async Task<ArmOperation<SecurityInsightsAlertRuleResource>> TriggerRuleRunAlertRuleAsync(WaitUntil waitUntil, AnalyticsRuleRunTrigger analyticsRuleRunTriggerParameter, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _alertRuleClientDiagnostics.CreateScope("SecurityInsightsAlertRuleResource.TriggerRuleRunAlertRule");
            scope.Start();
            try
            {
