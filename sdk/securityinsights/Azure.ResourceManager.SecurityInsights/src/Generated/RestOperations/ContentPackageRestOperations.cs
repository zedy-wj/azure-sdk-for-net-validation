...
{
    internal partial class ContentPackageRestOperations
    {
        ...
        /// <summary> Initializes a new instance of ContentPackageRestOperations. </summary>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <param name="apiVersion"> Api Version. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="pipeline"/> or <paramref name="apiVersion"/> is null. </exception>
        public ContentPackageRestOperations(HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
        ...
        public async Task<Response<SecurityInsightsPackageData>> InstallAsync(string subscriptionId, string resourceGroupName, string workspaceName, string packageId, SecurityInsightsPackageData data, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateInstallRequest(subscriptionId, resourceGroupName, workspaceName, packageId, data);
        ...
        internal RequestUriBuilder CreateUninstallRequestUri(string subscriptionId, string resourceGroupName, string workspaceName, string packageId)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateUninstallRequest(string subscriptionId, string resourceGroupName, string workspaceName, string packageId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="workspaceName"/> or <paramref name="packageId"/> is an empty string, and was expected to be non-empty. </exception>
        public async Task<Response> UninstallAsync(string subscriptionId, string resourceGroupName, string workspaceName, string packageId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));
            ...
            using var message = CreateUninstallRequest(subscriptionId, resourceGroupName, workspaceName, packageId);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="workspaceName"/> or <paramref name="packageId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="workspaceName"/> or <paramref name="packageId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response Uninstall(string subscriptionId, string resourceGroupName, string workspaceName, string packageId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(workspaceName, nameof(workspaceName));
