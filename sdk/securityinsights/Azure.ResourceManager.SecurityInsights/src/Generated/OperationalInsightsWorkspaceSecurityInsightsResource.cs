...
namespace Azure.ResourceManager.SecurityInsights
{
    ...
    public partial class OperationalInsightsWorkspaceSecurityInsightsResource : ArmResource
    {
        ...
        public virtual async Task<Response<WorkspaceEnrichmentIPGeodata>> GetGeodataByIPAsync(WorkspaceEnrichmentType enrichmentType, EnrichmentIPAddressContent content, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual Response<WorkspaceEnrichmentIPGeodata> GetGeodataByIP(WorkspaceEnrichmentType enrichmentType, EnrichmentIPAddressContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual async Task<Response<EnrichmentDomainWhois>> GetWhoisByDomainAsync(WorkspaceEnrichmentType enrichmentType, EnrichmentDomainContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual Response<EnrichmentDomainWhois> GetWhoisByDomain(WorkspaceEnrichmentType enrichmentType, EnrichmentDomainContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<ThreatIntelligenceCount>> CountThreatIntelligenceAsync(ThreatIntelligenceType tiType, CountQuery query = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual AsyncPageable<ThreatIntelligenceObject> QueryThreatIntelligencesAsync(ThreatIntelligenceType tiType, ThreatIntelligenceCountQuery query = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual Pageable<ThreatIntelligenceObject> QueryThreatIntelligences(ThreatIntelligenceType tiType, ThreatIntelligenceCountQuery query = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _threatIntelligenceRestClient.CreateQueryRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, tiType, query);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _threatIntelligenceRestClient.CreateQueryNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, tiType, query);
