...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class RaiBlocklistItemData : ResourceData
    {
        ...
        internal RaiBlocklistItemData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, RaiBlocklistItemProperties properties, ETag? etag, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
