...
{
    /// <summary>
    /// A Class representing a CognitiveServicesConnection along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="CognitiveServicesConnectionResource"/>
    /// from an instance of <see cref="ArmClient"/> using the GetCognitiveServicesConnectionResource method.
    /// Otherwise you can get one from its parent resource <see cref="CognitiveServicesAccountResource"/> using the GetCognitiveServicesConnection method.
    /// </summary>
    public partial class CognitiveServicesConnectionResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="CognitiveServicesConnectionResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="CognitiveServicesConnectionResource"/> class for mocking. </summary>
        protected CognitiveServicesConnectionResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CognitiveServicesConnectionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal CognitiveServicesConnectionResource(ArmClient client, CognitiveServicesConnectionData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<CognitiveServicesConnectionResource>> UpdateAsync(CognitiveServicesConnectionPatch patch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual Response<CognitiveServicesConnectionResource> Update(CognitiveServicesConnectionPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
