...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class RaiBlocklistData : ResourceData
    {
        ...
        internal RaiBlocklistData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, RaiBlocklistProperties properties, ETag? etag, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
