...
{
    public partial class ManagedNetworkSettingsPropertiesBasicResourceData : IUtf8JsonSerializable, IJsonModel<ManagedNetworkSettingsPropertiesBasicResourceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedNetworkSettingsPropertiesBasicResourceData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ManagedNetworkSettingsPropertiesBasicResourceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ManagedNetworkSettingsPropertiesBasicResourceData IJsonModel<ManagedNetworkSettingsPropertiesBasicResourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ManagedNetworkSettingsPropertiesBasicResourceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ManagedNetworkSettingsPropertiesBasicResourceData DeserializeManagedNetworkSettingsPropertiesBasicResourceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ManagedNetworkSettingsProperties.DeserializeManagedNetworkSettingsProperties(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<ManagedNetworkSettingsPropertiesBasicResourceData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ManagedNetworkSettingsPropertiesBasicResourceData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ManagedNetworkSettingsPropertiesBasicResourceData IPersistableModel<ManagedNetworkSettingsPropertiesBasicResourceData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ManagedNetworkSettingsPropertiesBasicResourceData>)this).GetFormatFromOptions(options) : options.Format;
