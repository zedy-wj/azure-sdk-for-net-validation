...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class NetworkSecurityPerimeterConfigurationCollection : ArmCollection, IEnumerable<NetworkSecurityPerimeterConfigurationResource>, IAsyncEnumerable<NetworkSecurityPerimeterConfigurationResource>
    {
        ...
        {
            _networkSecurityPerimeterConfigurationClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.CognitiveServices", NetworkSecurityPerimeterConfigurationResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<NetworkSecurityPerimeterConfigurationResource>> GetAsync(string nspConfigurationName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _networkSecurityPerimeterConfigurationRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, nspConfigurationName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<NetworkSecurityPerimeterConfigurationResource> Get(string nspConfigurationName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _networkSecurityPerimeterConfigurationRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, nspConfigurationName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new NetworkSecurityPerimeterConfigurationResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string nspConfigurationName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _networkSecurityPerimeterConfigurationRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, nspConfigurationName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string nspConfigurationName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _networkSecurityPerimeterConfigurationRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, nspConfigurationName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
