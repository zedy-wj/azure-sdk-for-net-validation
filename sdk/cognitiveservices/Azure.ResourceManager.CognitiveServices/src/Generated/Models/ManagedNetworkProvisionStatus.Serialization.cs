...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedNetworkProvisionStatus>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static ManagedNetworkProvisionStatus DeserializeManagedNetworkProvisionStatus(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ManagedNetworkProvisionStatus(status, serializedAdditionalRawData);
        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ManagedNetworkStatus), out propertyOverride);
            ...
            else
            {
                ...
                {
                    builder.Append("  status: ");
                    builder.AppendLine($"'{ManagedNetworkStatus.Value.ToString()}'");
                }
            }
