...
{
    public partial class SafetyProviderConfig : IUtf8JsonSerializable, IJsonModel<SafetyProviderConfig>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SafetyProviderConfig>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SafetyProviderConfig>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        SafetyProviderConfig IJsonModel<SafetyProviderConfig>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SafetyProviderConfig>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static SafetyProviderConfig DeserializeSafetyProviderConfig(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SafetyProviderConfig(safetyProviderName, blocking, serializedAdditionalRawData, source);
        }
        ...
        BinaryData IPersistableModel<SafetyProviderConfig>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SafetyProviderConfig>)this).GetFormatFromOptions(options) : options.Format;
        ...
        SafetyProviderConfig IPersistableModel<SafetyProviderConfig>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SafetyProviderConfig>)this).GetFormatFromOptions(options) : options.Format;
