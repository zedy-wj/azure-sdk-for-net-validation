...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class VersionedAgentReference : AgentReferenceProperties
    {
        ...
        internal VersionedAgentReference(string agentId, string agentName, IDictionary<string, BinaryData> serializedAdditionalRawData, string agentVersion) : base(agentId, agentName, serializedAdditionalRawData)
        {
