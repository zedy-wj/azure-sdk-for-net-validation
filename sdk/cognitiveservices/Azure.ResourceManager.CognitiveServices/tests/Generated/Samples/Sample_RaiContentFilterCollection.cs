...
{
    public partial class Sample_RaiContentFilterCollection
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Get_GetRaiContentFilters()
        {
            // Generated from example definition: specification/cognitiveservices/resource-manager/Microsoft.CognitiveServices/preview/2025-10-01-preview/examples/GetRaiContentFilter.json
            ...
            RaiContentFilterResource result = await collection.GetAsync(filterName);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetAll_ListRaiContentFilters()
        {
            // Generated from example definition: specification/cognitiveservices/resource-manager/Microsoft.CognitiveServices/preview/2025-10-01-preview/examples/ListRaiContentFilters.json
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Exists_GetRaiContentFilters()
        {
            // Generated from example definition: specification/cognitiveservices/resource-manager/Microsoft.CognitiveServices/preview/2025-10-01-preview/examples/GetRaiContentFilter.json
            // this example is just showing the usage of "RaiContentFilters_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_GetRaiContentFilters()
        {
            // Generated from example definition: specification/cognitiveservices/resource-manager/Microsoft.CognitiveServices/preview/2025-10-01-preview/examples/GetRaiContentFilter.json
            // this example is just showing the usage of "RaiContentFilters_Get" operation, for the dependent resources, they will have to be created separately.
