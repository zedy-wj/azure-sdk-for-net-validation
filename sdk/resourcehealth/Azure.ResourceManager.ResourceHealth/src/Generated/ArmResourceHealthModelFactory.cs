...
namespace Azure.ResourceManager.ResourceHealth.Models
{
    ...
    public static partial class ArmResourceHealthModelFactory
    {
        ...
        public static ResourceHealthAvailabilityStatusData ResourceHealthAvailabilityStatusData(ResourceIdentifier id = default, string name = default, ResourceType? @type = default, string location = default, ResourceHealthAvailabilityStatusProperties properties = default)
        {
        ...
        public static ResourceHealthMetadataEntityData ResourceHealthMetadataEntityData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, string displayName = default, IEnumerable<string> dependsOn = default, IEnumerable<MetadataEntityScenario> applicableScenarios = default, IEnumerable<MetadataSupportedValueDetail> supportedValues = default)
        {
            return new ResourceHealthMetadataEntityData(
                ...
                systemData,
                additionalBinaryDataProperties: null,
                displayName is null && dependsOn is null && applicableScenarios is null && supportedValues is null ? default : new ResourceHealthMetadataEntityProperties(displayName, (dependsOn ?? new ChangeTrackingList<string>()).ToList(), (applicableScenarios ?? new ChangeTrackingList<MetadataEntityScenario>()).ToList(), (supportedValues ?? new ChangeTrackingList<MetadataSupportedValueDetail>()).ToList(), null));
        }
