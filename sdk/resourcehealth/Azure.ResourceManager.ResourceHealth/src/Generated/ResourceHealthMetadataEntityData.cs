...
namespace Azure.ResourceManager.ResourceHealth
{
    ...
    public partial class ResourceHealthMetadataEntityData : ResourceData
    {
        ...
        internal ResourceHealthMetadataEntityData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ResourceHealthMetadataEntityProperties properties) : base(id, name, resourceType, systemData)
        {
        ...
        internal ResourceHealthMetadataEntityProperties Properties { get; }
