...
namespace Azure.ResourceManager.ResourceHealth
{
    ...
    /// Each <see cref="ResourceHealthEventResource"/> in the collection will belong to the same instance of <see cref="TenantResource"/>.
    /// To get a <see cref="ResourceHealthEventCollection"/> instance call the GetEvents method from an instance of <see cref="TenantResource"/>.
    /// </summary>
    public partial class ResourceHealthEventCollection : ArmCollection, IEnumerable<ResourceHealthEventResource>, IAsyncEnumerable<ResourceHealthEventResource>
    {
        ...
        {
            this.TryGetApiVersion(ResourceHealthEventResource.ResourceType, out string eventApiVersion);
            ...
            ResourceHealthEventCollection.ValidateResourceId(id);
        }
        ...
        public virtual AsyncPageable<ResourceHealthEventResource> GetAllAsync(string filter = default, string queryStartTime = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ResourceHealthEventData, ResourceHealthEventResource>(new EventsGetByTenantIdAsyncCollectionResultOfT(_eventsRestClient, filter, queryStartTime, context, "ResourceHealthEventCollection.GetAll"), data => new ResourceHealthEventResource(Client, data));
        }
        ...
        public virtual Pageable<ResourceHealthEventResource> GetAll(string filter = default, string queryStartTime = default, CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<ResourceHealthEventData, ResourceHealthEventResource>(new EventsGetByTenantIdCollectionResultOfT(_eventsRestClient, filter, queryStartTime, context, "ResourceHealthEventCollection.GetAll"), data => new ResourceHealthEventResource(Client, data));
        }
