...
namespace Azure.ResourceManager.ResourceHealth
{
    ...
    public partial class ResourceHealthAvailabilityStatusData : ProxyResourceAutoGenerated
    {
        ...
        internal ResourceHealthAvailabilityStatusData(ResourceIdentifier id, string name, ResourceType? @type, string location, IDictionary<string, BinaryData> additionalBinaryDataProperties, ResourceHealthAvailabilityStatusProperties properties) : base(id, name, @type, location, additionalBinaryDataProperties)
        {
