...
namespace Azure.ResourceManager.ResourceHealth.Mocking
{
    ...
    public partial class MockableResourceHealthSubscriptionResource : ArmResource
    {
        ...
        {
            return this.GetCachedClient(client => new ResourceHealthEventCollection(client, Id));
        }
        ...
        public virtual AsyncPageable<AvailabilityStatusResource> GetAvailabilityStatusesAsync(string filter = default, string expand = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ResourceHealthAvailabilityStatusData, AvailabilityStatusResource>(new AvailabilityStatusesGetBySubscriptionIdAsyncCollectionResultOfT(
        ...
        public virtual Pageable<AvailabilityStatusResource> GetAvailabilityStatuses(string filter = default, string expand = default, CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<ResourceHealthAvailabilityStatusData, AvailabilityStatusResource>(new AvailabilityStatusesGetBySubscriptionIdCollectionResultOfT(
                AvailabilityStatusesRestClient,
                Id.SubscriptionId,
                filter,
                expand,
