...
namespace Azure.ResourceManager.ResourceHealth.Mocking
{
    ...
    public partial class MockableResourceHealthArmClient : ArmResource
    {
        ...
        public virtual AsyncPageable<ResourceHealthAvailabilityStatusData> GetAllAsync(ResourceIdentifier scope, string filter = default, string expand = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="scope"/> is null. </exception>
        /// <returns> A collection of <see cref="ResourceHealthAvailabilityStatusData"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<ResourceHealthAvailabilityStatusData> GetAll(ResourceIdentifier scope, string filter = default, string expand = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(scope, nameof(scope));
