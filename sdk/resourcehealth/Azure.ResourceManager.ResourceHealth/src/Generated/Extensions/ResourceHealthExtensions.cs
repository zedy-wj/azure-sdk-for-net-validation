...
namespace Azure.ResourceManager.ResourceHealth
{
    ...
    public static partial class ResourceHealthExtensions
    {
        ...
        /// <summary>
        /// Gets an object representing a <see cref="AvailabilityStatusResource"/> along with the instance operations that can be performed on it but with no data.
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableResourceHealthArmClient.GetAvailabilityStatusResource(ResourceIdentifier)"/> instead. </description>
        /// </item>
        /// </summary>
        ...
        public static AvailabilityStatusResource GetAvailabilityStatusResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockableResourceHealthArmClient(client).GetAvailabilityStatusResource(id);
        }

        /// <summary>
        /// Gets an object representing a <see cref="AvailabilityStatusResource"/> along with the instance operations that can be performed on it in the ArmClient
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableResourceHealthArmClient.GetAvailabilityStatus(ResourceIdentifier)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient"/> the method will execute against. </param>
        ...
        public static AvailabilityStatusResource GetAvailabilityStatus(this ArmClient client, ResourceIdentifier scope)
        {
            ...
            return GetMockableResourceHealthArmClient(client).GetAvailabilityStatus(scope);
        }

        /// <summary>
        /// Gets an object representing a <see cref="ChildAvailabilityStatusResource"/> along with the instance operations that can be performed on it but with no data.
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableResourceHealthArmClient.GetChildAvailabilityStatusResource(ResourceIdentifier)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient"/> the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static ChildAvailabilityStatusResource GetChildAvailabilityStatusResource(this ArmClient client, ResourceIdentifier id)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableResourceHealthArmClient(client).GetChildAvailabilityStatusResource(id);
        }

        /// <summary>
        /// Gets an object representing a <see cref="ChildAvailabilityStatusResource"/> along with the instance operations that can be performed on it in the ArmClient
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableResourceHealthArmClient.GetChildAvailabilityStatus(ResourceIdentifier)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient"/> the method will execute against. </param>
        /// <param name="scope"> The scope that the resource will apply against. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="client"/> is null. </exception>
        /// <returns> Returns a <see cref="ChildAvailabilityStatusResource"/> object. </returns>
        public static ChildAvailabilityStatusResource GetChildAvailabilityStatus(this ArmClient client, ResourceIdentifier scope)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableResourceHealthArmClient(client).GetChildAvailabilityStatus(scope);
        }
        ...
        public static AsyncPageable<ResourceHealthAvailabilityStatusData> GetAllAsync(this ArmClient client, ResourceIdentifier scope, string filter = default, string expand = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(client, nameof(client));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="client"/> is null. </exception>
        /// <returns> A collection of <see cref="ResourceHealthAvailabilityStatusData"/> that may take multiple service requests to iterate over. </returns>
        public static Pageable<ResourceHealthAvailabilityStatusData> GetAll(this ArmClient client, ResourceIdentifier scope, string filter = default, string expand = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(client, nameof(client));
        ...
        /// <summary>
        /// Gets a collection of Events in the <see cref="TenantResource"/>
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableResourceHealthTenantResource.GetEvents()"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="tenantResource"> The <see cref="TenantResource"/> the method will execute against. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tenantResource"/> is null. </exception>
        /// <returns> An object representing collection of Events and their operations over a ResourceHealthEventResource. </returns>
        public static ResourceHealthEventCollection GetEvents(this TenantResource tenantResource)
        {
            Argument.AssertNotNull(tenantResource, nameof(tenantResource));

            return GetMockableResourceHealthTenantResource(tenantResource).GetEvents();
        }
        ...
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableResourceHealthTenantResource.GetEventAsync(string, string, string, CancellationToken)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="tenantResource"> The <see cref="TenantResource"/> the method will execute against. </param>
        /// <param name="eventTrackingId"> Event Id which uniquely identifies ServiceHealth event. </param>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="tenantResource"/> is null. </exception>
        [ForwardsClientCalls]
        public static async Task<Response<ResourceHealthEventResource>> GetEventAsync(this TenantResource tenantResource, string eventTrackingId, string filter = default, string queryStartTime = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tenantResource, nameof(tenantResource));

            return await GetMockableResourceHealthTenantResource(tenantResource).GetEventAsync(eventTrackingId, filter, queryStartTime, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableResourceHealthTenantResource.GetEvent(string, string, string, CancellationToken)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="tenantResource"> The <see cref="TenantResource"/> the method will execute against. </param>
        /// <param name="eventTrackingId"> Event Id which uniquely identifies ServiceHealth event. </param>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="tenantResource"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<ResourceHealthEventResource> GetEvent(this TenantResource tenantResource, string eventTrackingId, string filter = default, string queryStartTime = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tenantResource, nameof(tenantResource));

            return GetMockableResourceHealthTenantResource(tenantResource).GetEvent(eventTrackingId, filter, queryStartTime, cancellationToken);
        }
